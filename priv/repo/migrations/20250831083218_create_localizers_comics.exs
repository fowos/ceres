defmodule Ceres.Repo.Migrations.CreateLocalizersComics do
  ...
  def change do
    create table(:localizers_comics, primary_key: false) do
      ...
      add :comic_id, references(:comics, on_delete: :delete_all, type: :binary_id), null: false
      add :localizer_id, references(:localizers, on_delete: :delete_all, type: :binary_id), null: false
